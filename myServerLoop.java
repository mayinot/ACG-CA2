 ...
 *
 *      The program will loop through after the client terminated
 *      the connection.
 *
 *	    Usage: java myServerLoop 9000
 *
 */
public class myServerLoop {
 ...
 */
  ...
  public static void main (String[] args) throws Exception {
    ...
    if (args.length != 1) {
      System.err.println("Usage: java myServerLoop port");
      System.exit(1);
    }
    ...
    System.out.println("Socket re-initialised.\n");

    // Re-initialise the connection and enter listing mode again
    cipherIn.close();
    in.close();
    out.close();
    socket.close();
